...
const App=()=>{
    ...
    <h1 className="head"> Bollywood movies list </h1>
    <input className="search" type="text" placeholder="movie here" 
    ...
    {Movies.map((Movies,index)=>{
        return(
            ...
            <p>{Movies.title}</p>
            <p>{Movies.year}</p>
            <h6>Released On : {Movies.releaseDate}</h6>
            <h6>Rating : {Movies.imdbRating}</h6>
            <p>{Movies.actors}</p>
            </div>
            )
    })}</div>
